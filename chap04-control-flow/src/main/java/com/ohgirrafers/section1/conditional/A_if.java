...
public class A_if {
    public void testNestIfStatement(){
        ...
        * if문은 조건식의 결과 값이 true 가 나오면 {} 안에 코드를 실행하고,
        * 조건식의 결과 값이 거짓이면 {} 안에 있는 코드를 무시하고 넘어간다.
        *
        * 정수 한개를 입력받아 그 수가 짝수면 "입력하신 숫자는 짝수입니다"라고 출력하고,
        * 짝수가 아니면 출력하지 않는 구문 작성해보자
        * 단, 조건과 상관없이 프로그램이 종료될때 "프로그램을 종료합니다" 라고 출력되게 한다.
        *
        * */
    ...
    public void testSimpleStatement(){
        ...
        /*
         * 정수 한개를 입력 받아서 그 수가 양수인 경우에만 짝수인지를 확인하여
